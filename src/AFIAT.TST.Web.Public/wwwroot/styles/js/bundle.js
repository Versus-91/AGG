...
var employeeId = (0, _utils.getUrlParams)("id");
  ...
  return {
    ...
    getEmployee: function getEmployee() {
      ...
      if (employeeId != null || employeeId != undefined) {
        (0, _api["default"])().get("/employees/".concat(employeeId)).then(function (response) {
...
},{"../utils/api":38,"../utils/utils":39}],33:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initEmployees = initEmployees;
...
function initEmployees() {
  return {
    ...
    getEmployees: function getEmployees() {
      ...
      (0, _api["default"])().get('/pages/getall').then(function (response) {
        console.log(response.data);
        _this.employees = response.data.result.items;
        _this.isLoading = false;
      })["catch"](function (error) {
        console.log(error);
      });
...
},{"../utils/api":38}],34:[function(require,module,exports){
"use strict";
...
function initNavbar() {
  return {
    ...
    searchData: function searchData(e) {
      ...
      var batch = (0, _searchJSON.searchJSON)(searchTerm, url);
    },
...
},{"./searchJSON":37}],35:[function(require,module,exports){
"use strict";
...
function getBaseAPI() {
  return _axios["default"].create({
    baseURL: '/api/services/app/' //baseURL: 'https://whispering-castle-04462.herokuapp.com/https://ninja-json-server.herokuapp.com'

  });
}

},{"axios":3}],39:[function(require,module,exports){
"use strict";
...
var _posts = require("./libs/components/posts");

var _employees = require("./libs/components/employees");

var _employee = require("./libs/components/employee");

var feather = require('feather-icons');

window.initNavbar = _navbar.initNavbar;
window.initPosts = _posts.initPosts;
window.initEmployees = _employees.initEmployees;
window.initEmployee = _employee.initEmployee;
...
},{"./libs/components/employee":32,"./libs/components/employees":33,"./libs/components/navbar":34,"./libs/components/pageloader":35,"./libs/components/posts":36,"./store/store":41,"alpinejs":2,"feather-icons":30}],41:[function(require,module,exports){
"use strict";
